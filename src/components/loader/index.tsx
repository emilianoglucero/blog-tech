      ...
      <div className={s.container} ref={containerRef}>
        ...
        <div className={s.text__container} ref={textContainerRef}>
          ...
          <div className={s.text}>
            ...
            :| : .8|| ,i||.!B: 8: |8i :88 8 B.88| : " . B! . .889oi6!.:.BB|B
            8✲'B "B|8 |. !8!!| .RB 88 "B!8 . .8|8.|8| 9 B :B:|. 8| 8.BB.8 BbT. d
            BB .8.✦ .l6? : |B.8Y Bo| |!8 .b .☆.|: B. B8 | ! |:B.B B☮.: :|8:.
            :":W 8 |:B ., b9B☮ ,.8 B!. | .:B o |.^:F f8|B88 :"'i .o = '. B8!.
            BB|:| .": ,8 | 88 R.|" f 8 8.: u | : 89b^ 8B..!!8 f."9|F.B.P8.
            8...BB8B.|!8 '!:| .B.!|B. .8.|F . f .8P8 9' ' .! 88 8 8.| . F ! 8 f
            :B?:b |. 8 . .B 8: B68 : .. o:Bf .b 8:8 .|☮8,. !. f! B||| | ..|.od
            !bT .|:|| B ! ;.9F |^ .| i |: B| 8 .8T:!|B f :B8 . .8B |T8:B: 8B |
            ☮f ; .|:. T 8; B|8|Y:|.| V. 88 !8 ! 8!8:^ 8B 9,: 8 |BT. :o- 8 f
            |:o||b 8 8 8|8B8: |. !.98 R 8!B ' :|'B :. 8|!o |.!6 8 8 .' 8| i.|8
            #. 'B:P!'.8 ✦Tb8B8.8 BB..8.B: P88:d.^ : ..B|.?: : ! B :| ||.a.|. B|.
            |o8? . 9 :.o|. 8;B. |B8 ! BBB_8.i' 88 =FB BP8.:.:B | B !BB... :o8!.
            .| B" 9 i 8.88.8:8 F.|8:B8..B!. B8 B8☮. B f.: | 8 88:✦ .?|Y8|Pb:| 8
            .. . !! :8 Ba ;:|B8 8. 8BB6 ☆. B,: :8!!B: |bB .B|i9. 8!8 8✲i.:| B 8
            B8 || |.8. ^ ..8.B B 9 888:8 B .8^: B9.| . | |!888 u.,:. . 9|8 , 6:Y
            ..|.:: 8|8 . ..B 8! B ?: ;|R .u8 ! 88 88: ..::B.' |8BF || BY R!B!!|
            ✦::" Y:.o-.: 886 8B.. 8B .8. ":. |8."f . ! V .:88 .9.|!.| !B ..Bo9:
            88 o 9T|BB6B|uBT:F|.8BF . f .8P8 9' ' .! 88 8 8.| . F ! 8 f :B?:b |.
            8 .
          </div>
          <div className={s.text}>
            B... b | ..oB| :8 .8B8| To| f P..:. .:B. BB:6'.!8_!: :T8:: 8 ✲!B:8.B
      ...
      <div className={s.container__overlay} ref={containerOverlayFinalRef}>
        ...
        >
          ...
          <div className={s.text__overlay}>
            ...
            8i.:| B 8 B8 || |.8. ^ ..8.B B 9 888:8 B .8^: B9.| . | |!888 u.,:. .
            9|8 , 6:Y ..|.:: 8|8 . ..B 8! B ?: ;|R .u8 ! 88 88: ..::B.' |8BF ||
            BY R!B!!| ::" Y:.o-.: 886 8B.. 8B .8. ":. |8."f . ! V .:88 .9.|!.|
            !B ..Bo9: 88 o 9T|BB6B|uBT:F|.8BF . f .8P8 9' ' .! 88 8 8.| . F ! 8
            f :B?:b |. 8 .
          </div>
