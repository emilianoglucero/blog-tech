...
const Page = () => {
  ...
  const paragraph2DescriptiontRef = useRef<HTMLParagraphElement>(null)
        ...
        <article className={s.main}>
          <div className={s.paragraph__1}>
            ...
            <div className={s.paragraph__content} ref={paragraph1ContentRef}>
              ...
              <p>
                ...
                by Olia Lialina. The storytelling, visuals, and interactions
                crafted purely with images and HTML captivated me. Then came
                JODI, Alexei Shulgin, Cory Arcangel, then Vuk Cosic, Molly Soda,
                Ben Growser then Mariela Yeregui, Gustavo Romano, Broken English
                and so many others. I quickly got trapped into the net art
                movement.
              </p>
              {/* <div className={s.paragraph__photo}>
          ...
          <div className={s.paragraph__2}>
            ...
            <div className={s.paragraph__content}>
              ...
              <p ref={paragraph2DescriptiontRef}>
                “Net art encompasses two distinct categories: artistic
                expressions that rely on the internet for their existence, and
              ...
              <p>
                In my early high school years (2003/2004), there was a
                government program that provided internet access at a minimal
                cost. Since my parents hadn't yet bought me a computer, I spent
                hours after school surfing the web. I believe that was when my
                fascination with the internet's potential began to take shape.
                While I didn't experience the heyday of personal web pages like
                Geocities, I had a period where my cultural consumption happened
                not through social media platforms, but through diverse and
                often unique web portals. These sites, while sharing certain
                design trends, still offered much more room for diversity
                compared to the repetitive templates of today's social media
                platforms. In a 2016 interview, Olia Lialina lamented the loss
                of personal web pages, stating, "The most important phenomena we
                lost [was] personal web pages. People don't build them and don't
                feel responsible for building the World Wide Web. That's the
                tragedy of today's Internet...we should take it very serious[ly]
                and [not] give up our 'corners of the cyberspace' to the
                aggregation networks of the future." In our contemporary online
                life, heavily mediated by a few centralized corporations, this
                concept drives my desire to build a more diverse and open
                internet. Another of Lialina's ideas that resonates with me is
                the concept of the "General Purpose User or Turing Complete
                User," a nod to Alan Turing. Lialina contrasts users, who
                control their computers, with people who passively experience
                technology. She challenges us to reclaim our user rights and
                demand better software, the ability to choose "none of the
                above," to delete our files, to recover lost files, to fail
                epically, and most fundamentally, to see the computer for what
                it is. The Turing Complete User is the opposite of an "invisible
                user"; it’s someone who can write an article in their email
                client, layout a business card in Excel, and even shave in front
                of a webcam. These users find ways to publish photos online
                without Flickr, tweet without Twitter, like without Facebook,
                add a black frame to a picture without Instagram, remove it from
                an Instagram picture, and wake up at 7 a.m. without an app.
                Lialina herself embodies this kind of user—enthusiastically
                using Twitter, but not as prescribed. She updates regularly but
                follows no one, preferring to read her friends' tweets
                sequentially rather than through a corporately defined
                algorithm. Turing Complete Users develop workarounds,
                consciously or not, to wrest control from the increasingly
                dominant technology-experience-person trifecta.
              </p>
              {/* <div className={s.paragraph__image}>
              <Image src={diagram} alt="Net art diagram" />
            </div> */}
          ...
          <div className={s.paragraph__3}>
            ...
            <div className={s.paragraph__content}>
              ...
              <p>
                In 2016, while learning web development, I had the idea to
                ...
                users by placing them in two states: inconvenience and constant
                doubt. So I built this website using the old boys: vanilla
                JavaScript, PHP, JQuery, p5.js, MySQL, CSS, a few Ajax calls
                (you may be old, but are you this old?), and a couple other
                libraries. Initially, I hosted it on a shared cheap hosting but
                later upgraded to a VPS to store and display user-drawn images,
                which wasn't possible on shared hosting. (A VPS is like renting
                your own mini-computer in the cloud. Unlike shared hosting where
                you're sharing resources with many other websites, a VPS gives
          ...
          <section className={s.imageGallery}>
            <div
              className={s.paragraph__image__item1}
              onMouseEnter={({ currentTarget }) => {
                console.log(currentTarget)
                const target = gsap.utils.selector(currentTarget)
                gsap.to(target('img'), {
                  scale: 2,
                  rotate: 11
                })
            ...
            >
              <Image src={bebeto} alt="bebeto.pizza webpage" />
            </div>
            <div
              className={s.paragraph__image__item1}
              onMouseEnter={({ currentTarget }) => {
            ...
            >
              <Image src={holadiego} alt="bebeto.pizza webpage" />
            </div>
            <div
              className={s.paragraph__image__item2}
              onMouseEnter={({ currentTarget }) => {
                console.log(currentTarget)
                const target = gsap.utils.selector(currentTarget)
                gsap.to(target('img'), {
            ...
            >
              <Image src={abrilaboca} alt="bebeto.pizza webpage" />
            </div>
            <div
              className={s.paragraph__image__item3}
              onMouseEnter={({ currentTarget }) => {
                console.log(currentTarget)
                const target = gsap.utils.selector(currentTarget)
                gsap.to(target('img'), {
            ...
            >
              <Image src={colorea} alt="bebeto.pizza webpage" />
            </div>
            <div
              className={s.paragraph__image__item4}
              onMouseEnter={({ currentTarget }) => {
                const target = gsap.utils.selector(currentTarget)
                gsap.to(target('img'), {
                  scale: 2,
          ...
          <div className={s.paragraph__4}>
            ...
            <div className={s.paragraph__content}>
              ...
              <p>
                ...
                <a href="">“Preservation by Accident is Not a Plan”</a> where
                Vint Cerf (Vice President and Chief Internet Evangelist for
                Google) and Dragan Espenschied (Preservation Director at
                Rhizome) discuss this topic in depth. I initially paid $31
                monthly for my VPS, before migrating to a cheaper $10/month
                option. I also renewed my domain annually (side note: my .pizza
                domain eventually increased to $99 per year—just a reminder that
                exotic domains can become expensive over time). Some people
                visited the site and hated it, others loved it. It was showcased
                in a few digital art pavilions. <br />
            ...
            <p>
              After years (2024), I decided it was time to improve my project in
              three main aspects:
            </p>
          </div> */}
          </div>
          <div className={s.paragraph__5} ref={paragraph5Ref}>
            ...
            <div className={s.paragraph__item2} ref={paragraph5Item2Ref}>
              ...
              <p>
                By redesigning and adapting it to support mobile devices and
                small screens.
              </p>
            </div>
          ...
          <div className={s.paragraph__6}>
            ...
            <div className={s.paragraph__content}>
              ...
              <p>
                I explored various bundler tools, including Vite, Webpack,
                Parcel, and Snowpack. Initially, I decided to try Vite due to
                its popularity, a few developers I know had started to use it
                and had good references, and also because features like instant
                server start and optimized build that were what I looked for.
              </p>
            </div>
          </div>
          <div className={s.paragraph__7}>
            <h2 className={s.paragraph__title}>5</h2>
            <div className={s.paragraph__content}>
              <h2>Migrating to Vite</h2>
              <p>
                During the migration, I noticed that Vite requires updating
                script tags to use the type="module" attribute. This change is
                necessary for Vite to handle scripts correctly and leverage
                modern browser features. Before Migration: After Migration:
              </p>
            </div>
          </div>
          <div className={s.paragraph__8}>
            <h2 className={s.paragraph__title}>6</h2>
            <div className={s.paragraph__content}>
              <h2>Challenges with ES Modules</h2>
              <p>
                However, I encountered several challenges that made it
                impractical to convert my existing JavaScript files to ES
                modules:
              </p>
            </div>
          </div>
          <div className={s.paragraph__9} ref={paragraph9Ref}>
            ...
            <div className={s.paragraph__item2} ref={paragraph9Item2Ref}>
              ...
              <p>
                The project consisted of multiple JavaScript files with
                intricate dependencies, tightly coupled and reliant on the
                global scope.
              </p>
            </div>
          ...
          <div className={s.paragraph__10}>
            ...
            <div className={s.paragraph__content} ref={paragraph10ContentRef}>
              ...
              <p>
                Ultimately, I chose to implement Webpack, allowing me to use
                classic script tags without the type="module" attribute while
                benefiting from a modern build process.
              </p>
            </div>
            ...
            <p className={s.paragraph__content5}>
              ...
              <br /> Flexible configuration allows tailoring the build process
              to specific needs.
            </p>
          </div>
          <div className={s.paragraph__11}>
            ...
            <div className={s.paragraph__content3}>
              <p>
                <a href="">HTML Webpack Deploy Plugin:</a> Simplifies the
                creation of HTML files to serve the bundled JavaScript.
              </p>
            </div>
            <div className={s.paragraph__content4}>
              <p>
                Just in case, this is how my Webpack configuration files looks:
              </p>
            </div>
            ...
            <div className={s.paragraph__content6}>
              <p>
                ...
                <br /> Plugins extend Webpack's functionality, such as copying
                files and generating HTML files.
              </p>
            </div>
            <div className={s.paragraph__content7}>
              <p>
                ...
                <br /> Loaders preprocess files before bundling, such as
          ...
          <div className={s.paragraph__12}>
            ...
            <div className={s.paragraph__content2}>
              <p>
                ...
                Instead, I’ve been using Node.js, so I feel more confident.
                Also, I like the idea of using only JavaScript and the benefits
                that Node.js offers, like easier integration with modern
                frontend frameworks like React, native support for JSON, a rich
                ecosystem, and better support for hosting platforms like Vercel
                or Heroku. For that, I created this Node.js + Express backend.
              </p>
            </div>
            <div className={s.paragraph__content3}>
              <p>
                ...
                <br />
                Why? Well, now I’m no longer using PHP, and the project doesn’t
                have complex database requirements. Since I’ve felt more
                confident with non-relational databases like MongoDB because of
                my work experience at a previous organization, it was suitable
                to use the schema-less nature for flexibility and scalability
                while unifying the development language.
              </p>
            </div>
            <div className={s.paragraph__content4}>
              <p>
                ...
                <br />
                Why? Because Vercel doesn't provide persistent storage for
                uploaded files. So I explored some external services like Amazon
                S3 and Google Cloud Storage. I finally picked Google Cloud
                Storage because it fits my simple needs and offers a free tier
            ...
            <div className={s.paragraph__content5}>
              <p>
                ...
                <br />
                Why? One of my main goals was to decrease the cost of my
                project. Since the visitors for this project are my friends and
                some freaks from the internet (I’m joking I love you), I could
                take advantage of some free tier that a hosting platform offers.
                I picked Vercel because I feel comfortable with the platform,
                having used it for the last three years, and it fits the current
            ...
            <div className={s.paragraph__content6}>
              <p>
                <span>
                  Redesign some sections of the project to adapt to mobile
                  devices and small screens, and add 3D graphics and motion. :
                </span>
                <br />
                ...
                2024, I think it is essential to offer the experience on
                people’s phones. I redesigned and re-adapted some interactive
                sections to work with mobile gestures. I’ve also been learning
                to render 3D graphics with Three.js, so I migrated from A-frame
                to Three.js and added some motion using GSAP (GreenSock
                Animation Platform).
              </p>
            </div>
          </div>
          <div className={s.paragraph__13} ref={paragraph13ContentRef}>
            <h2 className={s.paragraph__title}>
              <span ref={paragraph13TitleRef}>10</span>
            </h2>
          </div>
          <div className={s.paragraph__14}>
            {/* <h2 className={s.paragraph__title}>10</h2> */}
            <div className={s.paragraph__content}>
              <h2>Conclusion</h2>
              <p>
                Creating, adapting, and migrating bebeto.pizza over the years
                has been an invaluable journey of learning and growth. This
                project has served as my personal playground for
                experimentation, pushing me to explore new technologies and
                overcome various challenges. It’s almost painful to revisit the
                initial codebase of the project released in 2018 filled with
                impractical patterns and less-than-ideal practices. However,
                I've come to embrace this as a testament to my evolution as a
                developer and the progress I've made over time. Working on a
                personal project like this comes with its own set of challenges.
                When you're the sole code reviewer, tech lead, and designer all
                rolled into one, maintaining best practices can be difficult.
                But it's precisely this hands-on, multifaceted experience that
                has been so educational. Finally https://bebeto.pizza is now
                more performant, cost-effective, and mobile-friendly. Please
                feel free to email me with any suggestion, questions or just to
                chat. I’m always eager to connect and learn from others in the
                community :)
              </p>
            </div>
            <div className={s.paragraph__content2}>
